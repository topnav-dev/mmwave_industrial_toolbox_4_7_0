...
SBL_LOC_LIBS = $(R4F_COMMON_LOC_LIB)									\
						  ...
						  -i$(MMWAVE_SDK_INSTALL_PATH)/ti/drivers/spi/lib	\
...
SBL_SOURCES = transport_spi.c buffer_mgmt.c sbl.c image_parser.c image_validity.c \
...
sbl: R4F_CFLAGS += -i$(MMWAVE_INDUSTRIAL_TOOL_PATH) --cmd_file=$(BUILD_CONFIGPKG)/compiler.opt
