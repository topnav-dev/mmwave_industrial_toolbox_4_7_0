// PROFILE CONFIG from profile_2d_bpm
...
#define CHIRP_HCC_0_TX_CHANNEL              (5U)
...
#define CHIRP_HCC_1_TX_CHANNEL              (5U)
...
#define BPM_HCC_ENABLED                     (1U)
#define BPM_HCC_CHIRP_0_IDX                 (0U)
#define BPM_HCC_CHIRP_1_IDX                 (1U)
