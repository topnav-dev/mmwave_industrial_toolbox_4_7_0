...
MMW_DEMO_STD_LIBS += -llibaoa2dproc_hwa_$(MMWAVE_SDK_DEVICE_TYPE).$(R4F_LIB_EXT)
else
MMW_DEMO_STD_LIBS += -llibaoaproc_hwa_$(MMWAVE_SDK_DEVICE_TYPE).$(R4F_LIB_EXT)
endif
...
ifeq ($(MMWAVE_SDK_LIB_BUILD_OPTION),AOP)
MMW_DEMO_LOC_LIBS += -i$(MMWAVE_SDK_INSTALL_PATH)/ti/datapath/dpc/dpu/aoa2dproc/lib
else
MMW_DEMO_LOC_LIBS += -i$(MMWAVE_SDK_INSTALL_PATH)/ti/datapath/dpc/dpu/aoaproc/lib
endif
...
MMW_DEMO_CONFIGPKG   = mmw_configPkg_xwr64xx$(MMWAVE_SDK_LIB_BUILD_OPTION)
MMW_DEMO_MAP         = xwr64xx$(MMWAVE_SDK_LIB_BUILD_OPTION)_mmw_demo_mss.map
MMW_DEMO_OUT         = xwr64xx$(MMWAVE_SDK_LIB_BUILD_OPTION)_mmw_demo_mss.$(R4F_EXE_EXT)
MMW_DEMO_METAIMG_BIN = xwr64xx$(MMWAVE_SDK_LIB_BUILD_OPTION)_mmw_demo.bin
MMW_DEMO_METAIMG_SECURE_BIN = xwr64xx$(MMWAVE_SDK_LIB_BUILD_OPTION)_mmw_demo_secure.bin
...
ifeq ($(MMWAVE_SDK_LIB_BUILD_OPTION),AOP)
mmwDemo: R4F_CFLAGS += --define=XWR68XX_AOP_ANTENNA_PATTERN \
...
mmwDemo: buildDirectories mmwRTSC $(MMW_DEMO_OBJECTS)
	...
	@$(GENERATE_HS_METAIMAGE) $(MMW_DEMO_METAIMG_SECURE_BIN) $(SHMEM_ALLOC) $(MMW_DEMO_OUT) $(XWR68XX_RADARSS_IMAGE_BIN) NULL $(MMWAVE_SECDEV_HSIMAGE_CFG)
...
mmwDemoClean:
	...
	@rm -f $(MMW_DEMO_OBJECTS) $(MMW_DEMO_MAP) $(MMW_DEMO_OUT) $(MMW_DEMO_METAIMG_BIN) $(MMW_DEMO_METAIMG_SECURE_BIN) $(MMW_DEMO_DEPENDS) $(MMW_DEMO_ROV_XS)
