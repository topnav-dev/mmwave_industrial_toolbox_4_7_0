...
#define MMWAVE_L3_RADARMEM_SIZE (MMWAVE_L3RAM_SIZE - MMWAVE_L3_CODEMEM_SIZE) 
...
PAGE 0:
    ...
    L3_RAM (RW)   : origin=0x51000000 length=MMWAVE_L3_RADARMEM_SIZE
    L3SRAM_CODE (R):origin=(0x51000000 + MMWAVE_L3_RADARMEM_SIZE) length=MMWAVE_L3_CODEMEM_SIZE 
