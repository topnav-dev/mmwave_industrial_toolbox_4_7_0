...
SECTIONS
{
    ...
    .dpc_l1Heap  : { } > L1DSRAM
    .dpc_l2Scratch: { } >> L2SRAM_UMAP0 | L2SRAM_UMAP1 
    .dpc_l2Heap: { } >> L2SRAM_UMAP0 (HIGH)
    ...
    */ 
    ...
    .unUsedCode:
    {
        ...
        RADARDEMO_aoaEst2DCaponBF_angleEst.oe674 (.text:RADARDEMO_aoaEst2DCaponBF_aeEstElevOnly)
		RADARDEMO_aoaEst2DCaponBF_angleEst.oe674 (.text:RADARDEMO_aoaEst2DCaponBF_aeEstElevAzim)
    } load=L3SRAMOVLY PAGE 0
